...
import { Video, FileText, TrendingUp, Clock, Users, LogOut, Settings } from "lucide-react"
...
export default function AdminDashboard({ user, onLogout }: AdminDashboardProps) {
  ...
  // Mock aggregated stats for all students or selected student
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">
                ...
                {isAllStudents
                  ...
                  : `Viewing ${students.find((s) => s.id === selectedStudent)?.name}`}
              </p>
            </div>
          ...
          <TabsContent value="overview" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  {isAllStudents ? "Latest activities from all students" : "Latest activities from selected student"}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
